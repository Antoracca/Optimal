...
export function ConfirmationMtnMomoCheckout({ visible, onCancel }: Props) {
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.pushCard}>
          ...
          <ActivityIndicator size="large" color="#FFCC00" style={styles.spinner} />
