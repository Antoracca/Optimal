...
import { ConfirmationMoovMoneyCheckout } from './ConfirmationMoovMoneyCheckout';

const moovLogoImage = require('../../../assets/moov_cropped.png');

export function MoovMoneyCheckout() {
  ...
  const isGabon = sourceCountry?.iso === 'GA';
  const placeholderNumber = isGabon ? '062 00 00 00' : '75 00 00 00';
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Paiement Moov Money</Text>
          <Pressable onPress={() => router.replace('/(tabs)/')} style={styles.closeButton} hitSlop={10}>
            <X size={22} color="#666660" weight="bold" />
          </Pressable>
        </View>

        {/* ── 2. Bandeau Supérieur Bleu Officiel Moov ── */}
        <View style={styles.moovBanner}>
          <View style={styles.brandLeftContainer}>
            ...
            <View style={styles.brandTexts}>
              <Text style={styles.brandTitle}>Moov Africa Money</Text>
        ...
        >
          ...
          <Pressable style={styles.returnMerchantRow} onPress={() => router.back()}>
            <CaretLeft size={16} color="#005B94" weight="bold" />
          ...
          <View style={styles.confirmSection}>
            ...
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>Numéro de mobile Moov (8 chiffres)*</Text>
              <TextInput
            ...
            <View style={styles.infoNoticeRow}>
              <View style={styles.infoIconWrap}>
                <Info size={18} color="#005B94" weight="fill" />
              </View>
              <Text style={styles.infoNoticeText}>
                Après avoir cliqué sur Confirmer, une invite de paiement sera envoyée sur votre mobile Moov. Vous pourrez également valider en composant le <Text style={styles.moovUssdText}>*155#</Text> ou via l'application Moov Money.
              </Text>
            </View>
          ...
          <View style={styles.promoSection}>
            ...
            <Text style={styles.promoTitle}>
              Gérez vos paiements simplement avec l'application Moov Africa {countryName}
            </Text>
